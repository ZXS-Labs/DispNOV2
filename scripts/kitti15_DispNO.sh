...
python main_kitti15_DispNO.py --dataset kittiDispNO \
    ...
    --model gwcnet-gc-dispno --logdir ./checkpoints/kitti15/DispNO_s1/ \
...
python main_kitti15_DispNO.py --dataset kittiDispNO \
    --datapath $DATAPATH --trainlist ./filenames/kitti15_train.txt --testlist ./filenames/kitti15_val.txt \
    --epochs 300 --lrepochs "200:10" \
    --model gwcnet-gc-dispno --logdir ./checkpoints/kitti15/DispNO_s2/ \
    --loadckpt ./checkpoints/sceneflow/DispNO/truetrue8/checkpoint_000049.ckpt \
    --test_batch_size 1 \
    --out_add 'true' --key_query_same 'true' --deformable_groups 8 \
    --output_representation 'bimodal' --sampling 'dda' \
...
python main_kitti15_DispNO.py --dataset kittiDispNO \
    --datapath $DATAPATH --trainlist ./filenames/kitti15_train.txt --testlist ./filenames/kitti15_val.txt \
    --epochs 300 --lrepochs "200:10" \
    --model gwcnet-gc-dispno --logdir ./checkpoints/kitti15/DispNO_s3/ \
    --loadckpt ./checkpoints/sceneflow/DispNO/truetrue8/checkpoint_000049.ckpt \
    --test_batch_size 1 \
    --out_add 'true' --key_query_same 'true' --deformable_groups 8 \
    --output_representation 'bimodal' --sampling 'dda' \

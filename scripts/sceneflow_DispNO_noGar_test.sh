...
python main_scene_DispNO_test.py --dataset sceneflowDispNO \
    ...
    --model gwcnet-gc-dispno-noGar --logdir ./checkpoints/sceneflow/test_DispNO_noGar \
    --loadckpt ./checkpoints/sceneflow/DispNO_noGar/truetrue8/checkpoint_000015.ckpt \

...
def test():
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        # test
        os.makedirs('./pred/sceneflow_DispNO_scale5', exist_ok=True)
        ...
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            do_summary = True
            scalar_outputs, image_outputs, disp_est_np = test_sample(sample, compute_metrics=do_summary)
            ...
            print('Epoch {}/{}, Iter {}/{}, epe = {:.3f}, time = {:3f}'.format(epoch_idx, args.epochs,
                                                                                     batch_idx,
            ...
            if batch_idx % 10 == 0:
                for disp_est, top_pad, right_pad, fn in zip(disp_est_np, top_pad_np, right_pad_np, left_filenames):
                    ...
                    fn_arr = fn.split('/')
                    fn = os.path.join("pred/sceneflow_DispNO_scale5", fn_arr[2] + '-' + fn_arr[3] + '-' + fn_arr[5])

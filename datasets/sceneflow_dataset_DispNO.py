...
# Scenceflow 960 * 540
class SceneFlowDatsetDispNO(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.training:
            ...
            # You can customize the crop size here. Note that crop_w/scale and crop_h/scale need to be divisible by 4
            if s < 5:
